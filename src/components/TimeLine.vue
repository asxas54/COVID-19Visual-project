...
export default {
    ...
    methods:{
      ...
      // 画标题
        ...
        ctx_title.fillText("2022年政策追踪", canvas_title.width / 2, 24);
        // 北京市
      ...
      // 颜色提示
        ...
        for(var i=0;i<dataSc.length-1;i++){
          ...
          drawPoint(ctx_school,x1,beginy,6,"#8B8378");
          drawArc(ctx_school,x1,beginy,4,"white");
        }
        }
        drawTimeLine(ctx_school,110,canvas_school.width-110,50,this.dataSc);
        //       // 画直线1.1
        // ctx_school.beginPath();
        ...
        if(this.regionName=="北京市"){
          ...
          ctx_school.beginPath();
          ctx_school.moveTo((canvas_school.width-110)*0.2+110, 50-4);
          ctx_school.lineTo((canvas_school.width-110)*0.2+110, 50-20);
          ctx_school.stroke();
        ...
        drawTimeLine(ctx_work,110,canvas_work.width-110,50,this.dataBu);
        ...
        if(this.regionName=="北京市"){
          ...
          ctx_work.moveTo(xt, 50-4);
          ctx_work.lineTo(xt, 50-20);
          ctx_work.stroke();
